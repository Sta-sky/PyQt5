...
from video_win import myVideoWidget, QCoreApplication
...
class Ui_MainWindow(object):
	def setupUi(self, MainWindow):
		...
		self.btn_3.setStyleSheet("background-color: rgb(129, 129, 129);\n"
		                                 "color: rgb(255, 255, 255);")
		...
		self.btn_5 = QtWidgets.QPushButton(self.frame_4)
		self.btn_5.setStyleSheet("background-color: rgb(129, 129, 129);\n"
		                                 "color: rgb(255, 255, 255);")
	...
	def retranslateUi(self, MainWindow):
		...
		self.btn_3.setText(_translate("MainWindow", "待定3"))
		...
		self.btn_5.setText(_translate("MainWindow", "待定5"))
