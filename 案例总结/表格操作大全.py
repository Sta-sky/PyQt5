...
class TableMain(QWidget):
    def __init__(self):
        ...
        # 设置某一列不可编辑
        # self.table_view.setItemDelegateForColumn(2, EmptyDelegate(self))  # 设置第二列不可编辑
        ...
        # 当前项目发生变化可以编辑
        self.table_view.setEditTriggers(QAbstractItemView.CurrentChanged)
        # 单机可以编辑
        self.table_view.setEditTriggers(QAbstractItemView.SelectedClicked)
        # 按下编辑键可以编辑
